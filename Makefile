...
test-all:
	...
	@echo "=========================================="
	@echo ""
	@echo "📝 1/9 - 创建对话元数据 (create_meta_async.py)"
	@cd examples && python create_meta_async.py
	@echo ""
	@echo "✅ 1/9 完成"
	@echo ""
	@echo "📝 2/9 - 异步添加记忆 (add_async.py)"
	@cd examples && python add_async.py
	@echo ""
	@echo "✅ 2/9 完成"
	@echo ""
	@echo "📝 3/9 - 同步添加记忆 (add_sync.py)"
	@cd examples && python add_sync.py
	@echo ""
	@echo "✅ 3/9 完成"
	@echo ""
	@echo "📝 4/9 - 批量导入记忆 (import_memories_async.py)"
	@cd examples && python import_memories_async.py
	@echo ""
	@echo "✅ 4/9 完成"
	@echo ""
	@echo "📝 5/9 - 获取记忆 (get_async.py)"
	@cd examples && python get_async.py
	@echo ""
	@echo "✅ 5/9 完成"
	@echo ""
	@echo "📝 6/9 - 获取元数据 (get_meta_async.py)"
	@cd examples && python get_meta_async.py
	@echo ""
	@echo "✅ 6/9 完成"
	@echo ""
	@echo "📝 7/9 - 搜索记忆 (search_async.py)"
	@cd examples && python search_async.py
	@echo ""
	@echo "✅ 7/9 完成"
	@echo ""
	@echo "📝 8/9 - 更新元数据 (update_meta_async.py)"
	@cd examples && python update_meta_async.py
	@echo ""
	@echo "✅ 8/9 完成"
	@echo ""
	@echo "📝 9/9 - 删除记忆 (delete_async.py)"
